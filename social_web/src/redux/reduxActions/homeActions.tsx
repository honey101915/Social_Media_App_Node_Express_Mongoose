import { ADD_NEW_POST, GET_ALL_COLLEGES, GET_ALL_POSTS, GET_ALL_SCHOOLS, GET_ALL_USERS, GET_USER_DETAIL, UPDATE_PROFILE } from "../../config/urls"
...
export const getAllCollegeApi = (_query: any) => {
    return new Promise((resolve, reject) => {
        apiGet(GET_ALL_COLLEGES + _query).then((res) => {
            resolve(res)
        }).catch((error) => {
            reject(error)
        })
...
export const updateProfileApi = (apiData: any) => {
    return new Promise((resolve, reject) => {
        apiPost(UPDATE_PROFILE, apiData).then((res) => {
            resolve(res)
        }).catch((error) => {
            reject(error)
        })
